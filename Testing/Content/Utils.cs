...
namespace Testing.Content
{
	...
	public class Utils
    {
        ...
        public SendMessageData GenerateChatSendMsgData(string msg = "Hello", int[] rcvIds = null, int replyId = -1,
        ...
        public MessageData GenerateChatMessageData(MessageEvent chatEvent = MessageEvent.NewMessage,
        ...
        public MessageData GenerateNewMessageData(string Message, int MessageId = 1, int[] rcvIds = null,
        ...
        public ReceiveMessageData GenerateNewReceiveMessageData(string Message, int MessageId = 1, int[] rcvIds = null,
            int ReplyThreadId = -1, int SenderId = -1, bool Starred = false, MessageType Type = MessageType.Chat)
        {
            if (rcvIds == null) rcvIds = new int[0];
            var msg = new ReceiveMessageData();
        ...
        public List<ChatContext> getlistContext(MessageData message)
        {
            ...
            var sampleData = new List<ChatContext>();
        ...
        {
            var sampleData = GetSendMessageData1();
            var conch = new ChatClient(_fakeCommunicator);
            var msgData = conch.SendToMessage(sampleData, MessageEvent.NewMessage);
            return msgData;
        }
