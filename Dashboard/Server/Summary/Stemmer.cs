namespace Dashboard.Server.Summary
{
	...
	public class PorterStemmer
    {
	    ...
	    private bool StemEndsWith(string s)
        {
            ...
            var word = new string(wordArray);
            var retVal = word.Substring(index, length) == s;
	    ...
	    private void Step4()
        {
            ...
            EndsWithStep4("ent");
            if (step4)
                if (StemEndsWith("ion") && stemIndex >= 0 &&
